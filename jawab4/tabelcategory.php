...
<html lang="en">
  ...
  <body>
            ...
            <div class="col-md">
             <div class="dropdown mt-5">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="tabelvideo.php">Video</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <tr>
        <td><?php echo $i; ?></td>
        <td>
          <a href="updatecategory.php?id=<?php echo $row["id"]; ?>" class=" bg-danger">Update</a> |
          <a href="deletecategory.php?id=<?php echo $row["id"]; ?>" class=" bg-danger" onclick="
...
<?php endforeach; ?>
      ...
      <div class="container">
      <a class="btn btn-primary" href="tabelvideo.php" role="button">beranda</a>
      </div>
