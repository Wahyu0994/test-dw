...
$cate = query("SELECT * FROM category WHERE id = $id")[0];
...
if (isset($_POST["submit"])) {
    ...
    if(ubah2($_POST) > 0) {
      ...
      document.location.href = 'tabelcategory.php';
      </script>
      ";
  ...
  <body>
    ...
    <section>
      <div class="container justify-content-center bg-secondary">
        ...
        <input type="text" class="form-control" name="name" id="name" required value="<?= $cate["name"]; ?>">
        <div class="container">
        ...
        <a class="btn btn-primary mt-3 mx-4" href="tabelcategory.php" role="button">Back</a>
        </div>
          </div>
           </form> 
         </div>
